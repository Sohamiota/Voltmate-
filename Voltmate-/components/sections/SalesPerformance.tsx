...
const STATUS_BADGE: Record<string, string> = {
  ...
  'Catalogue Shared':        'bg-sky-500/15 text-sky-300 border-sky-500/25',
            ...
            <table className="w-full" style={{ minWidth: 640 }}>
              ...
              <tbody>
                {recentVisits.map((v, i) => (
                    <tr key={v.id}
                      className={`${i !== recentVisits.length - 1 ? 'border-b border-border/50' : ''} hover:bg-secondary/30 transition-colors`}>
