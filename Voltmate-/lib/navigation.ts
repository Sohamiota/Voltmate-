...
export const ROUTE_LABELS: Record<string, string> = {
  ...
  '/service-manager/customers': 'Customer Hub',
...
export const ROUTE_PARENTS: Record<string, string> = {
  ...
  '/vehicle-videos':            '/',
  '/service-manager':           '/',
  '/service-manager/customers': '/service-manager',
...
export const EXTRA_SEARCH_ROUTES: Array<{ route: string; label: string; keywords?: string[] }> = [
  ...
  { route: '/service-manager/customers', label: 'Customer Hub',        keywords: ['service', 'customers', 'fleet'] },
