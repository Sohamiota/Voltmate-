...
const departmentData = [
  { name: 'Sales', value: 45, color: 'hsl(var(--primary))' },
  { name: 'Service', value: 30, color: 'hsl(var(--secondary))' },
  { name: 'HR', value: 15, color: 'hsl(200, 10%, 50%)' },
  { name: 'Admin', value: 10, color: 'hsl(120, 70%, 50%)' },
]
